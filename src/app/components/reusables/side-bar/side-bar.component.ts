...
import { ADMIN_MENU, MenuItem, OPERATEUR_MENU, RESPONSABLE_MENU } from '@/app/utils/sidebarMenus';
...
export class SideBarComponent {
  ...
  ngOnInit(): void {
    ...
    else if (this.role === UserRole.operateur) {
      this.menuItems = OPERATEUR_MENU;
    }
  }
